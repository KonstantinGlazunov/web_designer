  ...
  de: {
    ...
    choose: {
      ...
      items: [
        ...
        { title: 'Web-App', text: 'Für Projekte, bei denen die Website nicht nur Informationen zeigt, sondern Funktionen übernimmt: Anfragen, Quiz, Terminbuchung, Chatbot, Integrationen oder Automatisierung.' },
      ],
    },
    extras: {
    ...
    form: {
      ...
      interestOptions: ['Start Website', 'Business Website', 'Web-App', 'Ich bin unsicher'],
      message: 'Nachricht',
  ...
  ru: {
    ...
    choose: {
      ...
      items: [
        ...
        { title: 'WEB Приложение', text: 'Для проекта, где сайт должен не только показывать информацию, но и выполнять функции: заявки, квиз, запись на термин, чат-бот, интеграции или автоматизация.' },
      ],
    },
    extras: {
    ...
    faq: {
      ...
      items: [
        ...
        { question: 'Когда нужно WEB Приложение?', answer: 'WEB Приложение нужно, если сайт должен не только информировать, но и выполнять логику: квиз, многошаговые формы, запись на термин, чат-бот, CRM, автоматизации или API-интеграции.' },
    ...
    form: {
      ...
      interestOptions: ['Start Website', 'Business Website', 'WEB Приложение', 'Я не уверен(а)'],
      message: 'Сообщение',
